<div id="content" style="opacity: 1;"><link href="/gsims/public/css/ProfileDefinition.css" rel="stylesheet" type="text/css">
                ...
                <div class="portlet light bordered padding0 marginBottom0">
                    <div class="portlet-title">
                        <div class="caption add_profile_label">
                            ...
                            <span class="caption-subject font-dark sbold uppercase caption_subject_profile">Grade
                        </div>
                    </div><!-- portlet-title -->
                    <div class="row customRow">
                          ...
                          <div class="col-md-4" id="sectionFilter_container">
...
$(document).on("click", "#Generate_Fee_Bill_1,#export_pdf,.Generate_Fee_Bill_1", function(){
 ...
 if(pdf=="1"){
              ...
              App.stopPageLoading(); 
               ...
               type:'GET',
               data: myData,
               url:  base_url + 'accounts/get_student_records?Grade_id='+Grade_id_list,
                success: function(response){
          ...
          console.log(data);
                 ...
                 for (var i = 0; i < response.length; i++) {
                   console.log(data[i]['gs_id']);
                   var gs_id = data[i]['gs_id'];
                       window.open(base_url+'reports/get_student_reports?Grade_id='+Grade_id_list+ 
               '&Gname='+Grade_names_list+'&Snames='+Section_names_list+'&gs_id='+gs_id
                )
                 }
         ...
         /*    window.open(base_url+'reports/get_student_reports?Grade_id='+Grade_id_list+ 
               '&Gname='+Grade_names_list+'&Snames='+Section_names_list
                );  */
                 App.stopPageLoading();      
...
loadScript("metronic/global/scripts/datatable.js", function(){
    loadScript("/gsims/public/metronic/pages/scripts/table-datatables-responsive.min.js", function(){
    loadScript("/gsims/public/metronic/global/plugins/datatables/datatables.min.js", function(){
        loadScript("/gsims/public/metronic/global/plugins/datatables/plugins/bootstrap/datatables.bootstrap.js", function(){
            loadScript("/gsims/public/metronic/pages/scripts/profile.js", function(){
                loadScript("/gsims/public/metronic/pages/scripts/table-datatables-managed.js", function(){
                    loadScript("/gsims/public/metronic/global/plugins/jquery.sparkline.min.js", function(){
                        loadScript("/gsims/public/metronic/global/plugins/jqvmap/jqvmap/jquery.vmap.js", function(){
                            loadScript("/gsims/public/metronic/layouts/layout/scripts/demo.min.js", function(){
                                loadScript("/gsims/public/js/jquery.filtertable.min.js", function(){
                                    loadScript("/gsims/public/metronic/global/plugins/jquery-validation/js/jquery.validate.min.js",function(){
                                         loadScript("/gsims/public/metronic/global/scripts/app.min.js", pagefunction)
                                    });
                                });
                            });
                        });
